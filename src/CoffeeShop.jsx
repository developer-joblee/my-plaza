    ...
    <group position={[0, 0, -2.38]}>
      ...
      <group position={[2.2, 1.65, 0]}>
        ...
        {[-0.95, -0.55, -0.15, 0.25, 0.65, 1.0].map((x, i) => (
          <Cyl
            key={i}
            args={[0.075, 0.055, 0.13, 16]}
            position={[x, 0.1, 0]}
            color={i % 2 ? C.white : '#f0e6d2'}
          />
        ))}
      </group>
    </group>
      ...
      <group rotation={[Math.PI / 7, 0, 0]} position={[0, -0.1, 0.55]}>
        {Array.from({ length: stripes }).map((_, i) => (
          <Box
            key={i}
            size={[0.85, 0.04, 1.3]}
            position={[-3.5 + i * 0.88, 0, 0]}
            color={i % 2 ? C.awningA : C.awningB}
          />
        ))}
        {Array.from({ length: stripes }).map((_, i) => (
...
function Sign({ position = [0, 3.4, 0.1] }) {
  return (
    <group position={position}>
      ...
      <mesh position={[-0.35, 0.18, 0.1]} rotation={[Math.PI / 2.5, 0, 0]}>
        <torusGeometry args={[0.04, 0.012, 8, 16, Math.PI]} />
        <meshStandardMaterial color="#a0775a" />
      </mesh>
      <mesh position={[-0.5, 0.2, 0.1]} rotation={[Math.PI / 2.5, 0, 0]}>
        <torusGeometry args={[0.04, 0.012, 8, 16, Math.PI]} />
        <meshStandardMaterial color="#a0775a" />
      </mesh>
      <mesh position={[-0.2, 0.2, 0.1]} rotation={[Math.PI / 2.5, 0, 0]}>
        <torusGeometry args={[0.04, 0.012, 8, 16, Math.PI]} />
        <meshStandardMaterial color="#a0775a" />
      </mesh>
  ...
  return (
    <group position={[0, 0, 2.5]}>
      ...
      <group position={[2.55, 1.15, 0]}>
        ...
        <Box size={[0.74, 0.06, 0.05]} position={[0, 0.9, 0.06]} color={C.woodDark} />
        <Box size={[0.74, 0.06, 0.05]} position={[0, 0.2, 0.06]} color={C.woodDark} />
        <Box size={[0.06, 0.74, 0.05]} position={[-0.35, 0.55, 0.06]} color={C.woodDark} />
        <Box size={[0.06, 0.74, 0.05]} position={[0.35, 0.55, 0.06]} color={C.woodDark} />
        <Cyl
          args={[0.035, 0.035, 0.06, 12]}
          position={[0.42, -0.15, 0.07]}
          rotation={[Math.PI / 2, 0, 0]}
          color={C.chrome2}
        />
...
function Plant({ position, size = 1, leafColor = C.leaf }) {
  return (
    <group position={position} scale={size}>
      ...
      {[
        [0, 0.52, 0, 0.18, 0],
        [0.13, 0.62, 0.06, 0.15, 0.6],
        [-0.11, 0.58, 0.08, 0.16, 1.2],
        [0.06, 0.72, -0.08, 0.14, 2.0],
        [-0.07, 0.75, 0.05, 0.15, 2.6],
        [0.0, 0.85, 0.0, 0.13, 3.0],
      ].map(([x, y, z, r, rot], i) => (
...
function Bicycle({ position = [-4.5, 0, 3.5] }) {
  return (
    <group position={position} rotation={[0, Math.PI / 8, 0]}>
      <Cyl
        args={[0.025, 0.025, 0.75, 8]}
        position={[0.3, 0.5, 0]}
        rotation={[0, 0, -Math.PI / 3.5]}
        color="#3a667a"
      />
      <Cyl
        args={[0.025, 0.025, 0.6, 8]}
        position={[-0.05, 0.4, 0]}
      ...
      <mesh position={[-0.4, 0.32, 0]} rotation={[Math.PI / 2, 0, 0]}>
        <cylinderGeometry args={[0.06, 0.06, 0.04, 12]} />
        <meshStandardMaterial color={C.chrome2} />
      </mesh>
      <mesh position={[0.6, 0.32, 0]} rotation={[Math.PI / 2, 0, 0]}>
        <cylinderGeometry args={[0.06, 0.06, 0.04, 12]} />
        <meshStandardMaterial color={C.chrome2} />
      </mesh>
...
function Steam({ position = [0, 0, 0] }) {
  return (
    <group position={position}>
      {[0.15, 0.32, 0.5].map((y, i) => (
        <mesh key={i} position={[Math.sin(i) * 0.04, y, 0]}>
          <sphereGeometry args={[0.06 + i * 0.02, 12, 12]} />
  ...
  return (
    <div
      style={{
        ...
        height: '100vh',
        background:
          'linear-gradient(180deg, #fbe6c2 0%, #f5cf9a 55%, #e2a872 100%)',
      }}
    >
